<template>
     <svg viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path fill="#fff" d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,
            ...
            C989.49,25,1113-14.29,1200,52.47V0Z" opacity=".25"/>
          <path fill="#fff" d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,
            ...
            c22.43-10.89,48-26.93,60.65-49.24V0Z" opacity=".5"/>
          <path fill="#fff" d="M0,0V5.63C149.93,59,314.09,71.32,475.83,42.57,
